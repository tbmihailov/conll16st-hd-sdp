...
#echo python sdp/sup_parser_v2_hierarchy_ext_multi_file_eval.py en ${input_dataset_train}  ${model_dir} ${output_dir} -run_name:${run_name} -cmd:${mode} -word2vec_model:${word2vec_model} -word2vec_load_bin:${word2vec_load_bin} -scale_features:${scale_features} -dataset_name:${dataset_name}
#python sdp/sup_parser_v2_hierarchy_ext_multi_file_eval.py en ${input_dataset_train}  ${model_dir} ${output_dir} -run_name:${run_name} -cmd:${mode} -word2vec_model:${word2vec_model} -word2vec_load_bin:${word2vec_load_bin} -scale_features:${scale_features} -dataset_name:${dataset_name}
...
echo python sdp/sup_parser_v2_hierarchy_ext_multi_file_eval.py en ${input_dataset_test}  ${model_dir} ${output_dir} -run_name:${run_name} -cmd:${mode} -word2vec_model:${word2vec_model} -word2vec_load_bin:${word2vec_load_bin} -scale_features:${scale_features} -dataset_name:${dataset_name}
